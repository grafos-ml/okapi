...
public class Als extends Vertex<IntWritable, DoubleArrayListHashMapWritable,
  ...
  public void compute(Iterable<MessageWrapper> messages) {
     ...
     * basic, rmse, l2norm
     **/
    String factorFlag = getContext().getConfiguration().get("als.factor",
      "basic");
  ...
  public double getError(DoubleArrayListWritable ma,
    ...
    // System.out.println("predicted: " + predicted + " - observed: " +
    // observed);
   ...
   * (from jblas library)
   ***/
  public DoubleMatrix DoubleArrayListWritable2DoubleMatrix(
    DoubleArrayListWritable ma, int size) {
